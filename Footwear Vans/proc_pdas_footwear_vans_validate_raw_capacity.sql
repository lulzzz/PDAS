...
-- Description:	Backend procedure to validate the staging area raw capacity table and generate a validatio report.
-- =============================================
ALTER PROCEDURE [dbo].[proc_pdas_footwear_vans_validate_raw_capacity]
AS
BEGIN
	SET NOCOUNT ON;
	...
	SET @source = 'PDAS_FTW_VANS_RAW_CAPACITY.xlsx';
