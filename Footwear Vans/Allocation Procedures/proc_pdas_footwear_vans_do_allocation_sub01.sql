...
BEGIN
	...
	BEGIN
		...
		ELSE
		BEGIN
			SET @allocation_logic = @allocation_logic +' => ' + ' 1st priority = COO China' + ' | Product ID not in priority list'
		END
	END
	...
	BEGIN
		...
		ELSE
		BEGIN
			SET @allocation_logic = @allocation_logic +' => ' + ' 1st priority = COO not China' + ' | Product ID not in priority list'
		END
	END
