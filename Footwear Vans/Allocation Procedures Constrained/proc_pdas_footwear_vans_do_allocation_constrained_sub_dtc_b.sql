...
-- Description:	Allocation sub procedure DTC Scnenario B
-- =============================================
ALTER PROCEDURE [dbo].[proc_pdas_footwear_vans_do_allocation_constrained_sub_dtc_b]
	@pdasid INT,
	@businessid INT,
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						ELSE
						BEGIN
							SET @allocation_logic = @allocation_logic +' => ' + 'Not found' + ' => ' + 'DTC'
						END
					END
				END
				ELSE
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					SET @dim_factory_id_original_constrained_02 = (SELECT [id] FROM [dbo].[dim_factory] WHERE [short_name] = @dim_factory_name_priority_list_primary_02)
					SET @allocation_logic = @allocation_logic +' => ' + '1st priority = not DTC' + ' => ' + 'SJV'
				END
			END
			ELSE
			BEGIN
				SET @allocation_logic = @allocation_logic +' => ' + 'Not Flex' + ' => ' + 'DTC'
			END
		END
	END
