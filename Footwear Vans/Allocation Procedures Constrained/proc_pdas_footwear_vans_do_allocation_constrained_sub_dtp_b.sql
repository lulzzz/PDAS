...
-- =============================================
ALTER PROCEDURE [dbo].[proc_pdas_footwear_vans_do_allocation_constrained_sub_dtp_b]
	@pdasid INT,
	@businessid INT,
...
BEGIN
	...
	-- Non-duty Beneficial: EU DC and EU Cross Dock
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				ELSE
				BEGIN
					SET @allocation_logic = @allocation_logic +' => ' + 'Not found' + ' => ' + 'DTP'
				END
			END
		END
	END
