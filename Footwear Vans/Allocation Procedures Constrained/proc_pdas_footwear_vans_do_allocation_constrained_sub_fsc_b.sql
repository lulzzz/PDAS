...
-- Description:	Allocation sub procedure FSC Scnenario B
-- =============================================
ALTER PROCEDURE [dbo].[proc_pdas_footwear_vans_do_allocation_constrained_sub_fsc_b]
	@pdasid INT,
	@businessid INT,
...
BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						ELSE
						BEGIN
							SET @allocation_logic = @allocation_logic +' => ' + 'Not found' + ' => ' + 'FSC'
						END
					END
				END
				ELSE
				BEGIN
					SET @allocation_logic = @allocation_logic +' => ' + 'FSC'
				END
			END
		END
	END
	...
	BEGIN
		...
		BEGIN
			...
			ELSE
			BEGIN
				SET @allocation_logic = @allocation_logic +' => ' + 'Flex' + ' => ' + 'FSC'
			END
		END
	END
